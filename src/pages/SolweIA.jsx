      ...
      setTimeout(async function() {
        ...
        if (resultado.ok) {
          ...
          setMessages(function(p) { return p.concat([{
            role: "assistant",
            text: "Proposta enviada com sucesso! Verifique seu email (" + emailDetectado + "). Você vai encontrar a proposta comercial e um link para navegar no protótipo interativo do seu sistema gerado por IA. O investimento estimado é de " + resultado.data.pricing.preco_total.toLocaleString("pt-BR", { style: "currency", currency: "BRL" }) + " com timeline de " + timelineTexto + ". Em breve nossa equipe entrará em contato!"
          }]); });
        } else {
          setMessages(function(p) { return p.concat([{
            role: "assistant",
